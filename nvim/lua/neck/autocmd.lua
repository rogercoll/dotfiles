	...
	callback = function()
		vim.schedule(function()
			vim.keymap.set(
				"n",
				"<leader>re",
				"oif err != err {<CR>}<ESC>Oreturn err<ESC>",
				{ desc = "[R]eturn [E]rror" }
			)
...
-- Autoload Otel collector skeleton
vim.api.nvim_command("autocmd BufNewFile *collector.yaml 0r ~/.config/nvim/skeletons/collector.yaml")
